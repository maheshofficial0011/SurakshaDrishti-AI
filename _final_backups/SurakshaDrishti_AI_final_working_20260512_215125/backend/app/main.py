...
app = FastAPI(title="SurakshaDrishti AI Backend", version="1.0.0")
...
def health():
    ...
    return {"status": "running", "system": "SurakshaDrishti AI"}
...
def root():
    ...
    return {"message": "SurakshaDrishti AI Backend Active"}
