...
/*
|--------------------------------------------------------------------------
| SurakshaDrishti AI — Final MVP Dashboard
|--------------------------------------------------------------------------
| Purpose:
...
function createHumanAssistantTone({
    query,
    baseReply,
    events = [],
    dispatches = [],
...
function AssistantSection({
    ...
    const sectionAssistantEndRef = useRef(null)
    ...
    return (
        <Panel title="🤖 SurakshaDrishti Command Assistant">
            <div
                style={{
                    display: "grid",
    ...
    const [assistantMessages, setAssistantMessages] = useState([
        {
            role: "assistant",
            text:
                "Hello, I am SurakshaDrishti Command Assistant. Ask about alerts, SOS, heatmap risk, pending incidents, or what to do next.",
        },
    ])
    ...
    return (
        <>
                    ...
                    >
                        <div>
                            <div style={{ color: "#bfdbfe", fontSize: "12px", fontWeight: "bold" }}>
                                SURAKSHADRISHTI COMMAND ASSISTANT
                            </div>
            ...
            <button
                ...
                title="Open SurakshaDrishti Command Assistant"
                style={{
                    position: "fixed",
                    right: "22px",
                    bottom: "22px",
...
function SectionPlaceholder({
    ...
    const sectionConfig = {
        ...
        assistant: {
            icon: "🤖",
            title: "SurakshaDrishti Command Assistant",
            description:
        ...
        >
            ...
            >
                <div style={{ marginBottom: "24px", textAlign: "center" }}>
                    ...
                    <h1 style={{ margin: 0, fontSize: "30px" }}>SurakshaDrishti AI</h1>
...
function ActiveEmergencyBanner({
    event,
    dispatches,
    getEventIcon,
    setActiveSection,
...
function getAuthorityStatusLabel(status) {
    /*
    |--------------------------------------------------------------------------
